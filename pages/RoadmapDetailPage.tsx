...
// Fix: Explicitly import from constants to resolve module issue
      ...
      <div className="flex items-start flex-grow">
        ...
        <div className="flex-grow">
          ...
          {item.externalResourceUrl && (
            <a
              href={item.externalResourceUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs mt-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 inline-flex items-center"
              onClick={(e) => e.stopPropagation()} // Prevenir que el click en este enlace active otros handlers del <li>
              aria-label={`Aprender más sobre ${item.name} (enlace externo)`}
            >
              Aprender más
